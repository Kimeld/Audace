...
<head>
    ...
    <title>Accueil | Audace Consulting</title>
...
<body>
    ...
    <div class="pos-f-t burger">
        <div class="collapse burgerDiv " id="navbarToggleExternalContent">
            <div class="p-4 burgerDiv navBackColor2 ">
                <a href="pages/quiSommesNous.html" class="menuA ">Qui sommes nous ?</a>



                <a href="pages/conseil.html" class="menuA">Conseil</a>

                <a href="pages/formation.html" class="menuA">Formations</a>

                <a href="pages/solution.html" class="menuA">Solution et coaching</a>

                <h5 class="menuA">Forum</h5>
                <a href="pages/news.html" class="MsousMenuF">À la une</a>
                <a href="pages/inscription.html" class="MsousMenuF">Contact</a>
                <a href="pages/devis.html" class="MsousMenuF">Devis</a>
    ...
    <header class="container-fluid menuContainer">
        <div class="menu col-lg-12 ">
            <div class="imgLogo "><a href="#"><img src="images/LogoAudaceAC-OR.png" alt=""></a></div>
            <div class="category  col-sm-1 col-sm-offset-1 col-md-2 col-md-offset-1 col-lg-2 col-lg-offset-1 col-xl-2 col-xl-offset-1"><a href="pages/quiSommesNous.html" class="quiSommes">Qui sommes-nous ?</a></div>
            <div class="category col-sm-1 col-sm-offset-1 col-md-1 col-md-offset-1 col-lg-1 col-lg-offset-1  col-xl-1 col-xl-offset-1"><a href="pages/conseil.html" class="conseil">Conseil</a></div>
            <div class="category col-sm-1 col-sm-offset-1 col-md-1 col-md-offset-1 col-lg-1  col-lg-offset-1  col-xl-1 col-xl-offset-1"><a href="pages/formation.html" class="formations">Formations </a></div>
            <div class="category col-sm-1 col-sm-offset-1 col-md-2 col-md-offset-1 col-lg-2 col-lg-offset-1 col-xl-2 col-xl-offset-1"><a href="pages/solution.html" class="solutions">Solutions et Coaching</a></div>
    ...
    <div id="carouselControls" class="carousel slide sliderHome " data-ride="carousel">

        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="images/image%20de%20fond%20test%202.png" alt="First slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="images/joanna-kosinska-129039-unsplash.png" alt="Second slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="images/image%20de%20fond%20test%202.png" alt="Third slide">
            </div>
        </div>
    ...
    <div class="container-fluid introductionDiv">
        <div class="intro col-sm-12 col-sm-offset-2 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-3  col-xl-6 col-xl-offset-3">
            <div class="EnSP">
                <a href="pages/quiSommesNous.html"><?php
...
<input type="hidden" id="param1" name="param1" value="">
            ...
            <div class="titreIntro">
                <h1>Audace consulting</h1>
            </div>
            <div class="texteIntro">
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quibusdam voluptatum, explicabo. Dolor doloribus omnis vel provident, consectetur, labore saepe magnam quaerat dolore quis. Vero ab quidem unde, sunt laborum voluptates.</p>
            </div>
            <div class="EnSP"><a href="pages/quiSommesNous.html">En savoir plus</a></div>
            -->
        </div>
    </div>
    <footer class="container-fluid footer">
        ...
        <div class="contact col-3 offset-0 offset-sm-4 offset-md-1  ">
            <div><a href="pages/inscription.html">Contact</a></div>
            <div><a href="pages/inscription.html">NewsLetter</a></div>
            <div><a href="pages/devis.html">Devis</a></div>
